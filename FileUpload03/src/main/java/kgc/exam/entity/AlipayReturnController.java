...
public class AlipayReturnController {
    ...
    public void AlipayReturn(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {// 调用SDK验证签名    AlipaySignature.rsaCheckV1(params, AlipayAttr.alipay_public_key, AlipayAttr.charset);
            signVerified = AlipaySignature.rsaCheckV1(params, AlipayAttr.alipay_public_key, AlipayAttr.charset);
